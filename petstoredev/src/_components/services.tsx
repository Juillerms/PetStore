                ...
                <div className="container mx-auto px-4">
                    <div>
                        ...
                        <div className="relative">
                                        ...
                                        <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3">
                                            <article className="bg-[#1e293e] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                                                ...
                                                <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                                    ...
                                                    <a href="#" className='flex items-center justify-center gap-2 hover:bg-red-400 px-4 py-1 rounded-md duration-300'>Entrar em Contato
                            ...
                            <button className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-7 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 '
                                    onClick={scrollNext}                            
                            >
